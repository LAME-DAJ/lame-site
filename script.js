const posts = [
  ...
  id: 9,
  title: "Feelings right now",
  date: "2026-02-21",
  type: "text",
  topics: ["Thoughts", "emotions"],
  content: `Right now I'm just confused with a hint of irrational urgency and emotions. Since I know these thoughts and feelings are irrational I'm getting annoyed that they keep cycling through. `
},{ 
  id: 10,
...
{ 
  ...
  type: "text",
  topics: [],
  content: `Okay maybe i did loose it a little bit but I think that's understandable given the circumstances.  Or maybe it just found it in a place I didn't know it was`
},{ 
  id: 21,
  title: "",
  date: "2026-02-22",
...
But don't  be adding shit I got enough on my own fr😂`
  ...
  type: "text",
  topics: ["Gangstalking", "gaslighting"],
  content: `I'm now back at square one also because I'm fully convinced, we'll mostly convinced that someone is using black magic andbor advanced technology to manipulate certain events in our lives which is why despite the lies I was drawn to the very people who are working against me if that makes sense. Out of curiosity of what was going on but now I'm back to having no one to lead me either way spiritual ( no one b I can trust) Religiously (it doesn't make sense to me/ no one I can trust) I don't know what to do now but wait for the next event. I don't know  why everybody decided to target me and my parents.  Or just but used them to get to me idk. But on a high note my mother is feeling better and judging from what I did hear it sounds like they are gonna leave her alone as for as attacks and everything so I'm back to just fighting for me.`
},{ 
  id: 1772081655091,
  title: "",
  date: "2026-02-26",
...
It affected me is not manipulative blame it's the truth and if you don't want to hear it but still sneak and listen and watch me any way your clearly apart of the problem look in the mirror watch yourself don't watch me. And I ain't prove shit nobody said about me I don't even know what was said cause yall busy running behind my back talking shit and talking in code to me instead of saying what you want I just know whatever it is is lies that's why yall won't really stand on it and speak directly to me have fun being weird stalkers and eating up what ever bull shit you getting fed. 2.I do think babies feel energy just like I don't wanna be around my brother and his wife because they think every time they bring my niece around it time to be on some goofy gangstalking shit(just like everybody else) and she dont want to come to me i dont blame her I dont want to feel the weird ass energy either. But yall keep bringing it to  me. 3.New challenge for 2026 if you cant be direct and if you can't site the source of what you think you talking about STFU talking to me peeping Tom ass hoes. This is for everybody and somebody specific take what resonates dummies. `
  ...
  type: "text",
  topics: [],
  content: `1 victim blaming is crazy. I'm tryna understand what's going on in people brain when everybody close to me conspire  against me and simultaneously switch up and I get blamed. 
2.since no one is direct these days I can only take the hint that yet some  more of my private data/media has been stolen and most likely manipulated and released behind my back. Yes private. I recorded it with intentions  of releasing it which is why I said so, many times during recording. But it did even make sense or feel right for a couple of reasons so I didn't and kept it a more of a reminder like"notes"
3. The point of it was (A) to "clear my name " or better yet my conscience by trying to figure out what could I have said (in private) that was so bad that everybody switched up.(B) to right what ever wrongs I felt like I did. 
